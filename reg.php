...
if(!isset($_SESSION['logged_user']))
{
echo "<input href='reg.php' value='Войти' name='log' onClick='test1(form)' id='submit' class='ui label' type='submit' ripple='ripple' style='background-color:#77afcb;color:#3e282a;'></input>";
echo "<a href='rega.php' class='ui label' ripple='ripple' style='background-color:#77afcb;color:#3e282a;'>Регистрация</a>";
echo "<a href='frg.php' class='ui label' ripple='ripple' style='background-color:#77afcb;color:#3e282a;'>Забыли парооль</a>";
} 
?>      
              </div>
        <div class="vertical-5">
