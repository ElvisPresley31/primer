...
<head>
    ...
    <link href="/reg/12.css" rel="stylesheet" />
       ...
       <div class="ui form">
                ...
                <div class="fields">
                    <div class="field" style="width:130px;position:relative;">
                        ...
                        <input style="widht: 100%;" name="data" placeholder="дд.мм.гггг" type="date" value="<?php echo @$data['data']; ?>" />
                                            </div>
                </div>
            ...
            <input type="text" name="tel" value="" size="20" placeholder="Введите ваш телефон" data-val="true" data-val-required="Заполните поле" name="tel" style="width:180px;" data-rule-regexp="^(([0-9]{3}\-[0-9]{7})|(_{3}\-_{7}))?$" minlength="10" value="<?php echo @$data['tel']; ?>"/>
            ...
            $(function($) {
               $('input[name="tel"]').mask("+7 (999) 999-99-99");
                    ...
                    <div class="six wide field" style="position:relative;">
                        <label>Email</label>
                        <input data-val="true" data-val-regex="Неверный адрес" data-val-regex-pattern="^(([A-Za-z0-9]+_+)|([A-Za-z0-9]+\-+)|([A-Za-z0-9]+\.+)|([A-Za-z0-9]+\++))*[A-Za-z0-9-_]+@((\w+\-+)|(\w+\.))*\w{1,63}\.[a-zA-Z]{2,6}$" data-val-required="Заполните поле" id="registerCustomer_Email" name="mail" type="text" placeholder="Введите ваш телефон" value="<?php echo @$data['mail']; ?>" />
